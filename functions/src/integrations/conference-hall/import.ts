...
async function loadConferenceHallToken(db: admin.firestore.Firestore, conferenceId: string): Promise<string> {
  ...
  /**
   * Token secret.
   * @param tokenSecretDoc ? tokenSecretDoc.data() Token secret doc ? token secret doc.data().
...
/**
 * Preload conference speakers docs.
 * @param db Firestore instance.
 * @param conferenceId Conference identifier.
 * @returns Promise resolved with the computed result.
 */
...
/**
 * Import all speakers batch.
 * @param db Firestore instance.
 * @param proposals Proposals.
 * @param conference Conference.
 * @param conferenceId Conference identifier.
 * @param personByConferenceHallId Person by conference hall id.
 * @param personByEmailLower Person by email lower.
 * @param report Report.
 * @returns Promise resolved with the computed result.
 */
...
/**
 * Loads existing persons by email index.
 * @param db Firestore instance.
 * @param uniqueSpeakers Unique speakers.
 * @returns Promise resolved with the computed result.
 */
...
/**
 * Creates or updates sessions batch.
 * @param db Firestore instance.
 * @param proposals Proposals.
 * @param conference Conference.
 * @param conferenceId Conference identifier.
 * @param sessionsByChId Sessions by ch id.
 * @param sessionTypeFormatMapping Session type format mapping.
 * @param speakerPersonIdByConferenceHallId Speaker person id by conference hall id.
 * @param conferenceSpeakerByPersonId Conference speaker by person id.
 * @param report Report.
 * @returns Promise resolved when the operation completes.
 */
...
/**
 * Synchronizes conference speakers for session.
...
function mapPerson(speaker: ConferenceHallSpeakerDto, conference: any, conferenceId: string, existing?: any): any {
  ...
  /**
   * Social links.
   * @param speaker.socialLinks ?? [] Speaker.social links ?? [].
   * @returns Computed result.
   */
...
/**
 * Merge submitted conference ids.
...
function mapSession(
  ...
  /**
   * Mapped session type.
   * @param conference.sessionTypes ?? [] Conference.session types ?? [].
   * @returns Computed result.
   */
  ...
  /**
   * Langs.
   * @param proposal.languages ?? ['FR'] Proposal.languages ?? ['fr'].
   * @returns Computed result.
   */
...
function findTrackId(conference: any, categories: string[]): string {
  ...
  /**
   * Found.
   * @param conference.tracks ?? [] Conference.tracks ?? [].
   * @returns Computed result.
   */
