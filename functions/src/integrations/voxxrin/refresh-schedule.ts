...
import { generateVoxxrinDescriptorForConference } from './generate-event-descriptor';
import { refreshVoxxrinFeedbackPrivateUrls } from './refresh-feedback-private-urls';

const VOXXRIN_SECRET_TOKEN_NAME = 'VOXXRIN_SECRET_TOKEN';

/**
 * Refreshes Voxxrin schedule.
