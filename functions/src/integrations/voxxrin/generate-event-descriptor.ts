...
/**
 * Generate Voxxrin event descriptor.
...
/**
 * Generate Voxxrin descriptor for conference.
 * @param db Firestore instance.
 * @param conferenceId Conference identifier.
 * @param preloadedConferenceData? Preloaded conference data?.
...
/**
 * Saves Voxxrin descriptor to storage.
 * @param conferenceId Conference identifier.
...
/**
 * Maps location.
 * @param locationConfig Location config.
 * @returns Computed result.
 */
 ...
 * @param sessionById Session by id.
 * @param personById Person by id.
 * @param timelineSlots Timeline slots.
 ...
 * Maps breaks.
 * @param timelineSlots Timeline slots.
 * @param slotTypeById Slot type by id.
 * @param timezone Timezone.
 * @param conferenceLanguages Conference languages.
 * @returns Computed result.
 */
function mapBreaks(
  timelineSlots: Map<string, TimelineSlot>,
 ...
 * Maps sponsors.
 * @param sponsors Sponsors.
 * @param sponsorTypes Sponsor types.
 * @returns Computed result.
 */
